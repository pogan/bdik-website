...
function sendLeadSampleSafe(email) {
  ...
  // Kod zakładany ręcznie w Stripe Dashboard (pole promotion code w Checkout);
  // bez konfiguracji wysyłamy samą próbkę.
  const promoCode = process.env.LEAD_PROMO_CODE || '';
