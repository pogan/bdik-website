...
const insertOrder = db.prepare(`
  INSERT INTO orders (
    token, user_id, email, format, filters, row_count, billed_count, amount, currency, status,
    terms_version, terms_accepted_at, withdrawal_consent_at
  )
  VALUES (
    @token, @user_id, @email, @format, @filters, @row_count, @billed_count, @amount, @currency, 'pending',
...
function createOrder({ userId = null, email = null, format, selection, rowCount, billedCount = null, amount, currency, termsVersion = null }) {
