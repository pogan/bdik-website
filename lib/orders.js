...
// Link do pobrania jest linkiem-uprawnieniem (capability URL): sam token wystarcza,
// żeby pobrać plik, więc musi być nieodgadywalny, wygasać i mieć limit użyć.
...
function downloadState(order) {
  ...
  const expiresAt = paidAt + DOWNLOAD_TTL_DAYS * 24 * 60 * 60 * 1000;
